defmodule Tasks1Web.TaskControllerTest do
  ...
  @create_attrs %{complete: true, description: "some description", taskname: "some taskname", timespent: 42}
  @update_attrs %{complete: false, description: "some updated description", taskname: "some updated taskname", timespent: 43}
  @invalid_attrs %{complete: nil, description: nil, taskname: nil, timespent: nil}
